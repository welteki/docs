...
| Metric                                  | Type       | Description                                     | Labels       | Edition     |
| ----------------------------------------| ---------- | ------------------------------------------------| -------------|-------------|
| `queue_worker_pending_messages`         | gauge      | Messages waiting to be completed                | `queue_name` | Pro Edition |
| `queue_worker_messages_processed_total` | gauge      | Total number of messages processed              | `queue_name` | Pro Edition |
| `queue_worker_messages_submitted_total` | gauge      | Total number of messages submitted to the queue | `queue_name` | Pro Edition |
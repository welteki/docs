...
## Provider
The [provider](https://docs.openfaas.com/architecture/faas-provider/) is the back-end API used by other OpenFaaS components like the Gateway. It exposes several metrics.
